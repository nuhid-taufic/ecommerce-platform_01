      ...
      <div className="max-w-3xl mx-auto px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-16">
          ...
          <div className="bg-white p-8 rounded-2xl border border-gray-100 shadow-sm">
            <Truck className="h-8 w-8 text-secondary mb-6" />
            ...
            <ul className="space-y-4 text-sm text-gray-500 font-light">
              ...
              <li className="flex justify-between border-b border-gray-100 pb-2">
                ...
                <span className="font-medium text-secondary">৳150.00</span>
              </li>
              <li className="flex justify-between pb-2">
                <span>International (7-14 days)</span>
                <span className="font-medium text-secondary">৳250.00</span>
              </li>
            </ul>
          ...
          {/* Returns Info Box */}
          <div className="bg-white p-8 rounded-2xl border border-gray-100 shadow-sm">
            <RotateCcw className="h-8 w-8 text-secondary mb-6" />
            <h2 className="text-xl font-medium text-secondary mb-4">
              Return Policy
            </h2>
        ...
        <div className="text-center p-8 bg-gray-100 rounded-2xl">
          ...
          <Link
            href="/contact"
            className="inline-block bg-primary text-white px-6 py-3 rounded-full text-xs font-bold uppercase tracking-widest hover:opacity-90 transition-colors"
          >
            Contact Support
          </Link>
        </div>
